...
class TipSplitterApp(ctk.CTk):
    ...
    def add_worker(self):
        ...
        point_optionmenu = ctk.CTkOptionMenu(worker_frame, values=["1", ".95", ".90", ".85", ".80", ".75", ".70", ".65", ".60", ".55", ".50", ".45", ".40", ".35", ".30", ".25", ".20", ".15", ".10", ".05", "0"])
    ...
    def export(self):
        ...
        def add_rows_to_sheet(rows_data):
            sheet_id = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' # Replace with your sheet ID
